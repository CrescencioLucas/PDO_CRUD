...
echo "<a href='create.php' class='btn btn-primary m-b-1em'>Criar Novo
Produto</a>";
...
echo "<td>";
// read one record
echo "<a href='read_one.php?id={$id}' class='btn btn-info m-r-
1em'>Ler</a>";
// we will use this links on next part of this post
echo "<a href='update.php?id={$id}' class='btn btn-primary m-r-
1em'>Editar</a>";
// we will use this links on next part of this post
echo "<a href='#' onclick='delete_user({$id});' class='btn btn-
danger'>Excluir</a>";
echo "</td>";
echo "</tr>";
}
